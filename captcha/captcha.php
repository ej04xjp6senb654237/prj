...
$maxStringLength = 5;						//Maximum length of the captcha string.
...
$captchaCharacters = "1234567890";
$caseSensitive = false;						//Make the captcha string case-sensitive.

$minFontSize = 16;							//The minimum font size in points.
$maxFontSize = 20;							//The maximum font size in points.
